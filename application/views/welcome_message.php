...
<body>
	...
	<main class="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800 ">
		<div class="flex items-start justify-between">
			<div id="mySidebar" class="lg:relative duration-300 lg:translate-x-1 -translate-x-96  absolute z-[9999] w-[50%] left-0 h-screen lg:my-4 lg:ml-4 shadow-lg lg:block lg:w-80">
				<div class="h-full relative bg-white lg:rounded-2xl rounded-tr-lg dark:bg-gray-700  overflow-y-auto scrollbar-hide">
					<div onclick="myFunction()" class="absolute top-2 right-2 text-white lg:hidden hover:cursor-pointer">
			...
			<div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
				<header class="z-40 items-center w-full h-16 bg-white shadow-lg dark:bg-gray-700 lg:rounded-2xl">
						...
						<div class="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
							<div class="container relative left-0 z-50 flex w-3/4 h-auto h-full">
								<div class="relative flex items-center w-full h-full lg:w-64 group">
									<button type="button" id="myToggle" onclick="myFunction()" class="hover:cursor-pointer group lg:hidden p-3 rounded-full block">
										<span class="w-[25px] h-[2px] my-2 block bg-white"></span>
										<span class="w-[25px] transition-all duration-300 group-hover:w-[15px] h-[2px] my-2 block bg-white"></span>
										<span class="w-[25px] transition-all duration-300 group-hover:w-[10px] h-[2px] my-2 block bg-white"></span>
									</button>
									...
									<input type="text" class="block w-full py-1.5 pl-4 pr-4 leading-normal rounded-2xl focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 ring-opacity-90 bg-gray-100 dark:bg-gray-800 text-gray-400 aa-input" placeholder="Search" />
	...
	<script>
		...
		const myFunction = () => {
			mySidebar.classList.toggle('-translate-x-96')
		}

		window.addEventListener('click', function(e) {
			if (e.target != myToggle) {
				mySidebar.classList.add('-translate-x-96')
			}
